...
import { MapPin, Clock, Train, ShoppingBag, Camera, Utensils } from 'lucide-react';
...
export default function LocationPreview() {
  ...
  const nearbyAttractions = [
    ...
    },
    {
      ...
      nameAr: 'ایستگاه اتوبوس السبخه',
      distance: '5 min walk',
      distanceAr: '۵ دقیقه پیاده‌روی',
      description: 'Main bus terminal',
      descriptionAr: 'ترمینال اصلی اتوبوس'
    },
    {
      icon: ShoppingBag,
      name: 'Gold Souq',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        >
          ...
          {nearbyAttractions.map((attraction, index) => (
            ...
            >
              <div className="glass-dark rounded-xl w-12 h-12 flex items-center justify-center flex-shrink-0">
